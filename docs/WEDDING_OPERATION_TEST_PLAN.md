...
| ID | 情境 | 驗收標準 | 實際結果 | 結果 |
|---|---|---|---|---|
| TM-01 | 30 人正常點擊 | 10 題完整；無提前完賽；記錄實際總時長 |  |  |
| TM-02 | 75 人正常點擊 | 10 題完整；無提前完賽；記錄實際總時長 |  |  |
| TM-03 | 150 人正常點擊 | 6:30–8:30，10/10 題，四獎完整 |  |  |
| TM-04 | 180 人容量測試 | 無錯誤、無遺失玩家，五隊皆不超過 50 人 |  |  |
| TM-05 | 極快點擊 | 不得跳過任何關卡，仍需完成 10 題才可完賽 |  |  |
| TM-06 | 幾乎不點擊 | 9:00 顯示終極衝刺，最晚 10:00 完成且仍有 10 題 |  |  |
...
以下任一情況必須判定 NO-GO：P0 未關閉、QR 無法供手機連線、玩家或隊伍資料錯亂、未完成 10 題、重置失效、投影無法恢復、音響無替代方案，或 LAN 備援未準備完成。
